...
class ${classPrefix}ConnectorUnitTest {
    ...
    void getMetadataService_returnsMetadataServiceInstance() {
        ...
        assertTrue(metadataService instanceof ${classPrefix}MetadataService);
    }
    ...
    void getQueryService_returnsQueryServiceInstance() {
        ...
        assertTrue(queryService instanceof ${classPrefix}QueryService);
    }
