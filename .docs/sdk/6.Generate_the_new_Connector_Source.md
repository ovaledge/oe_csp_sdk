...
**Step 6 — Next steps:** Follow the generated `INSTRUCTIONS.txt` in the connector module root to add the module to the parent POM, `csp-api`, and assembly (same steps as in [Section 9](#9-assemble-the-new-connector)).
...
---
[⬅️ Previous: 5. What you will develop](5.What_you_will_develop.md)

[➡️ Next: 7. Compile, Build and Run](7.Compile_Build_Run.md)