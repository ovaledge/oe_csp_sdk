...
import com.ovaledge.csp.apps.awsconsole.main.AwsConsoleConnector;
...
/**
 * REST controller for standalone testing of the AWS Console connector.
 * Base path: /api/awsconsole
 */
@RestController
@RequestMapping("/api/" + AwsConsoleConstants.SERVER_TYPE)
@CrossOrigin(origins = "${csp.cors.allowed-origins:http://localhost:3000}")
public class AwsConsoleController {

    private final AwsConsoleConnector connector = new AwsConsoleConnector();
